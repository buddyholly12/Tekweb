    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="main.php">Admin panel Controlling </a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Admin's Report</h1>
                    <!-- notification message -->
                      <div class="col-lg-4">
                    <div class="panel panel-red">
                        <div class="panel-heading" style="text-align: center;"> User's Score
                        </div>
